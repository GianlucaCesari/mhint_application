...
class SettingsController: UICollectionViewController, UICollectionViewDelegateFlowLayout{
    ...
    func profileImage() {
        ...
        self.buttonImgProfile.frame = CGRect(x: self.globalSize.widthScreen*0.1, y: self.globalSize.heightScreen*0.22, width: self.globalSize.widthScreen*0.2, height: self.globalSize.widthScreen*0.2)
